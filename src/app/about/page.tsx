  ...
  return (
    <div className="max-w-4xl mx-auto text-right font-urdu" dir="rtl">
      ...
      <div className="lg:text-[18px] md:text-[16px] sm:text-[14px] text-[#0d1d16] p-3 mb-4 leading-[2.5rem]">
        ...
        <i>
          &quot;تمہیں یہ بھول کیسے سکتا ہے؟ یہ تو دین کی بنیادی باتیں ہیں!&quot;
        </i>
        <br />
        <i>
          &quot;تم کس قسم کی مسلمان ہو، جو انبیاء کے بارے میں نہیں جانتی؟&quot;
          🕊️
        </i>
        <br />
        <br />
        ...
        <i>&quot;کیا کوئی اور بھی ایسا ہے، جو یاد نہیں رکھ پاتا؟&quot;</i>{" "}
        <br />
        <i>
          &quot;کیا کوئی اور بھی ہے، جو میرے جیسا شرمندہ ہے، پوچھ نہیں
          پاتا؟&quot;
        </i>
        <br />
        <br />
        ...
        جن کے دل ہمیشہ آہستگی سے کہتے ہیں:{" "}
        <i>&quot;کاش میں اور جانتی...&quot;</i> 💫
        <br />
        <br />
      ...
      <div className="lg:text-[18px] md:text-[16px] sm:text-[14px] p-3 leading-[2.5rem]">
        ...
        جو <i>الزہراء</i> کے لقب سے جانی جاتیں — <i>&quot;روشن&quot;</i> 🌟{" "}
        <br />
